...
class GUI : public QMainWindow {            // SAU QWidget la toate in loc de QMainWindow si QDialog
private:
...
//    QTableWidget* trenchCoatTableWidget{};
    ...
    QPushButton* addButton{}, *deleteButton{}, *updatePriceButton{}, *updateQuantityButton{}, *graphicalReprButton{};
